  ...
  return (
    <header className="border-b border-campus-navy/10 bg-campus-cream/95 backdrop-blur sticky top-0 z-20">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link
          to="/"
          className="font-display text-xl font-700 tracking-tight text-campus-navy"
        >
          Uni
          <span className="text-campus-gold">
            Shop
          </span>
        </Link>
        ...
        <nav className="flex items-center gap-4 text-sm font-medium">
          <Link
            to="/"
            className="hover:text-campus-gold transition-colors"
          >
            Marketplace
          </Link>
